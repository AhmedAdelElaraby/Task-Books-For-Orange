...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxConstraintlayoutLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>constraint.layout.compose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompose() {
    ...
    public static class AndroidxNavigationRuntimeLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>navigation.runtime.ktx</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKtx() {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>landscapist</b> with value <b>2.4.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ConstraintVersionAccessors extends VersionFactory  {
        ...
        /**
         * Group of versions at <b>versions.constraint.layout</b>
         */
        public ConstraintLayoutVersionAccessors getLayout() {
    ...
    public static class ConstraintLayoutVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>constraint.layout.compose</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCompose() { return getVersion("constraint.layout.compose"); }
    ...
    public static class LoggingVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>logging.interceptor</b> with value <b>5.0.0-alpha.14</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class MaterialIconsVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>material.icons.extended</b> with value <b>1.7.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class NavigationVersionAccessors extends VersionFactory  {
        ...
        private final NavigationRuntimeVersionAccessors vaccForNavigationRuntimeVersionAccessors = new NavigationRuntimeVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.navigation.runtime</b>
         */
        public NavigationRuntimeVersionAccessors getRuntime() {
            return vaccForNavigationRuntimeVersionAccessors;
        }

    }

    public static class NavigationRuntimeVersionAccessors extends VersionFactory  {

        public NavigationRuntimeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>navigation.runtime.ktx</b> with value <b>2.8.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKtx() { return getVersion("navigation.runtime.ktx"); }
